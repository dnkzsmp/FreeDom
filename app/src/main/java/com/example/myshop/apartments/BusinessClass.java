...
public class BusinessClass extends AbstractApartment {

    public BusinessClass(int floor, int countOfRooms, int countOfSleepingPlaces, String housingArea) {
        super(floor, countOfRooms, countOfSleepingPlaces, housingArea);
        statusOfApartment = HousingStatus.BUSINESS_CLASS;
    }
