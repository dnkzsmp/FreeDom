...
public class Duplex extends AbstractHouse {

    public Duplex(int floor, int countOfRooms, int countOfSleepingPlaces, String housingArea) {
        super(floor, countOfRooms, countOfSleepingPlaces, housingArea);
        statusOfHouse = HousingStatus.DUPLEX;
    }
