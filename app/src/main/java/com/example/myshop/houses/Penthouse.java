...
public class Penthouse extends AbstractHouse {

    public Penthouse(int floor, int countOfRooms, int countOfSleepingPlaces, String housingArea) {
        super(floor, countOfRooms, countOfSleepingPlaces, housingArea);
        statusOfHouse = HousingStatus.PENTHOUSE;
    }
